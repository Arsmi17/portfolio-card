...
export function PortfolioView({ profile: initialProfile, links }: PortfolioViewProps) {
  ...
  useEffect(() => {
    ...
    fetchData()
    // Load Lottie from public folder
    fetch("/heart.json")
      .then((res) => res.json())
            ...
            <CardContent className="pb-6">
              {projects.length > 0 ? (
                <div className="relative">
                  ...
                  <div className="relative h-[570px] mb-4">
                        ...
                        >
                          <div className="p-4 h-full flex flex-col">
                            {project.youtube_link ? (
                              <div className="w-full h-80 mb-3 relative group">
                                <iframe
  ...
  <Badge variant="default">
    {project.category}
            ...
            {blogPosts.length > 0 ? (
              <div className="relative">
                <div className="min-h-[280px] mb-4">
                  <div 
                      className="rounded-lg border-2 p-6 bg-card flex flex-col h-full cursor-pointer"
                      onClick={() => handleBlogClick(blogPosts[currentBlog])}
                  >
                    <img
                    ...
                    <div className="flex-1 mb-4">
                      <p
                        ...
                        dangerouslySetInnerHTML={{
                          __html: blogPosts[currentBlog]?.description,
                        }}
                      />
                    </div>
        ...
        {selectedBlog && <BlogModal blog={selectedBlog} isOpen={isBlogModalOpen} onClose={handleCloseBlogModal} />}
      </div>
    </div>
  )
}
